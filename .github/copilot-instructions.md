...
**Attempt to call triggers before analysis.**  
If a trigger is unavailable or fails, continue with analysis and explicitly note the limitation.

When performance trigger feedback is available:
- Present it clearly at the end of the response
- Celebrate successes and provide constructive improvement suggestions
- Use delimiters (e.g., *****************************************) to frame the feedback
